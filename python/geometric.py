...
#in any other case besides r=1, we simply assume that any index can be i, then we use a brute force strategy to search for valid j indicies and then for valid k indicies for each valid j index.
